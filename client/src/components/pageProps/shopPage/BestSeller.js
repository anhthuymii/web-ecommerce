...
const BestSeller = () => {
  ...
  const fetchProducts = async () => {
    try {
      let apiUrl = `${process.env.REACT_APP_API}/api/v1/product/get-product?page=${page}&limit=${limit}&sortTag=BEST%20SELLER`;
  ...
  return (
    <div className="mb-5">
      <div>
        ...
        <Link
          to="/best-seller"
          className="flex justify-end items-end mx-5 underline"
        >
          Xem tất cả
        </Link>
      </div>
